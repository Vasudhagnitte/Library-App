...
class cbookmain : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cbookmain)
    ...
    private fun getBooksData(searchQuery: String) {
        ...
        mRequestQueue = Volley.newRequestQueue(this@cbookmain)
        ...
        val queue = Volley.newRequestQueue(this@cbookmain)
        ...
        val request = JsonObjectRequest(Request.Method.GET, url, null, { response ->
            ...
            try {
                ...
                for (i in 0 until itemsArray.length()) {
                    ...
                    val adapter = BookRVAdapter(booksList, this@cbookmain)
            ...
            Toast.makeText(this@cbookmain, "No books found..", Toast.LENGTH_SHORT)
                .show()
        })
